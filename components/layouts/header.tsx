...
const Header = () => {
    ...
    const [user, setUser] = useState<{nome: string, email: string} | undefined>(undefined)
    ...
    useEffect(()=>{
        ...
        const user = cookies["xicobless_user"] ? JSON.parse(cookies["xicobless_user"]): undefined
    ...
    const [notifications, setNotifications] = useState([
        {
            ...
            message: '<strong class="text-sm mr-1">Hospital vida e saúde</strong>Solicitou <strong>10 Vigas de aço</strong>',
            time: '45 min ago',
        },
        {
            id: 2,
            profile: 'user-profile.jpg',
            message: '<strong class="text-sm mr-1">Condomínio Bela Vista</strong>solicitou <strong>20 sacos de cimento</strong>',
            time: '9h Ago',
        },
        {
            id: 3,
            profile: 'user-profile.jpg',
            message: '<strong class="text-sm mr-1">Cimento</strong>Foi aprovada acompra',
            time: '9h Ago',
        },
    ]);
                    ...
                    <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                        ...
                        <div className="dropdown flex shrink-0">
                            <Dropdown
                                ...
                                button={<img className="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="/assets/images/user-profile.jpg" alt="userProfile" />}
                            >
                                <ul className="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="h-10 w-10 rounded-md object-cover" src="/assets/images/user-profile.jpg" alt="userProfile" />
                ...
                <ul className="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-black dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <Link href="/propriedades">{t('Propriedades')}</Link>
                            </li>
                            <li>
                                <Link href="/stock">{t('Stock')}</Link>
                            </li>
                            <li>
                                <Link href="/clietes">{t('Clientes')}</Link>
                            </li>
                            <li>
                                <Link href="/relatorios">{t('Relatórios')}</Link>
                            </li>
                        </ul>
                    </li>
                </ul>
